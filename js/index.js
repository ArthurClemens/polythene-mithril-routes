...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var polythene_mithril__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! polythene-mithril */ "../node_modules/polythene-mithril/dist/polythene-mithril.mjs");
...
const getTabs = currentRoute => {
  const firstTabRoute = currentRoute === "/" ? "/search" : "/";
  const selectedIndex = routeData.reduce((acc, d) => d.route === currentRoute ? d.tabIndex : acc, undefined);
  const tabs = [{
    label: "Search",
    element: mithril__WEBPACK_IMPORTED_MODULE_1___default.a.route.Link,
    url: {
      href: firstTabRoute,
      selector: 'a'
    }
...
const Navigation = {
  view: () => {
    const currentRoute = mithril__WEBPACK_IMPORTED_MODULE_1___default.a.route.get();
    const {
      tabs,
      selectedIndex
    } = getTabs(currentRoute);
    return mithril__WEBPACK_IMPORTED_MODULE_1___default()(polythene_mithril__WEBPACK_IMPORTED_MODULE_0__["Tabs"], {
      tabs,
      autofit: true,
      activeSelected: true,
...
const App = {
  view: () => [mithril__WEBPACK_IMPORTED_MODULE_1___default()(Navigation), mithril__WEBPACK_IMPORTED_MODULE_1___default()(".tabs-body", mithril__WEBPACK_IMPORTED_MODULE_1___default()("h1", mithril__WEBPACK_IMPORTED_MODULE_1___default.a.route.get()), mithril__WEBPACK_IMPORTED_MODULE_1___default()(polythene_mithril__WEBPACK_IMPORTED_MODULE_0__["TextField"], {
    label: mithril__WEBPACK_IMPORTED_MODULE_1___default.a.route.get(),
    floatingLabel: true
  })), mithril__WEBPACK_IMPORTED_MODULE_1___default()("div", routeData.map(({
    name,
    route
  }) => mithril__WEBPACK_IMPORTED_MODULE_1___default()(polythene_mithril__WEBPACK_IMPORTED_MODULE_0__["Button"], {
    label: name,
    element: mithril__WEBPACK_IMPORTED_MODULE_1___default.a.route.Link,
    url: {
      href: route,
...
mithril__WEBPACK_IMPORTED_MODULE_1___default.a.route.prefix = '#';
const routes = routeData.reduce((acc, {
  route
}) => (acc[route] = App, acc), {});
mithril__WEBPACK_IMPORTED_MODULE_1___default.a.route(document.body, "/home", routes);
